...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pkgcloud/node_modules/pkgcloud/lib/pkgcloud/amazon/compute/flavor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pkgcloud/node_modules/pkgcloud/lib/pkgcloud/amazon/compute/flavor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pkgcloud/node_modules/pkgcloud/lib/pkgcloud/amazon/compute/</a> &#187; flavor.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var id = details.name || 'm1.small';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!Flavor.options[id]) {</span>
<span class="cstat-no" title="statement not covered" >    throw new TypeError('No such AWS Flavor: ' + id);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.id   = id;</span>
<span class="cstat-no" title="statement not covered" >  this.name = id;</span>
<span class="cstat-no" title="statement not covered" >  this.ram  = Flavor.options[id].ram;</span>
<span class="cstat-no" title="statement not covered" >  this.disk = Flavor.options[id].disk;</span>
};
&nbsp;
Flavor.prototype.toJSON = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return _.pick(this, ['id', 'name', 'ram', 'disk' ]);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
